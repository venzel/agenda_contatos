...
<body>
	...
	<a href="/gerenciador/contatos?usuarioId=${contato.usuario.id}">Voltar para agenda</a>
	...
	<a href="/gerenciador/adicionarEndereco?contatoId=${contato.id}&usuarioId=${contato.usuario.id}">Adicionar endereco</a>
</body>
</html>